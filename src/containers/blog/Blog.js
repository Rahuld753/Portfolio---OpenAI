...
const Blog = () => {
    return (
        <div className='template__blog section__padding'>
            <div className='template__blog-heading'>
                <h1 className='gradient__text'>A lot is happening, We are blogging about it.</h1>
            </div>
            <div className='template__blog-articles'>
                <div className='template__blog-articles_groupA'>
                    <Article imgUrl={blog01} date={"Sep 26, 2021"} title="GPT-3 and Open  AI is the future. Let us exlore how it is?" />
                </div>
                <div className='template__blog-articles_groupB'>
